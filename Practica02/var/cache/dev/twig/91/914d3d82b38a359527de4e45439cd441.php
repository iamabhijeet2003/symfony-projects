...
class __TwigTemplate_48148aa0a7f682b5f3e9c658e342db5b extends Template
{
    private $source;
    private $macros = [];
    ...
    <main class=\"centered\">
        ...
        <p>You can see the full  <a href =\"";
        // line 7
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("contact_list");
        echo "\">list of contacts</a></p>
        <p>Or try to search a <a href =\"";
        // line 8
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("single_contact");
        echo "\">contact</a> by its id</p>
    </main>
...
";
    ...
    {
        return array (  78 => 8,  74 => 7,  68 => 3,  58 => 2,  35 => 1,);
    }
...
{% block body %}
    ...
    <main class=\"centered\">
        <h1>My Contacts App</h1>
        <h2>Welcome to my Contacts App</h2>
        <p>You can see the full  <a href =\"{{ path('contact_list') }}\">list of contacts</a></p>
        <p>Or try to search a <a href =\"{{ path('single_contact') }}\">contact</a> by its id</p>
    </main>

{% endblock %}", "main_page/index.html.twig", "/home/abhijeet/Escritorio/symfony/practica1contactes/templates/main_page/index.html.twig");
    }
}
