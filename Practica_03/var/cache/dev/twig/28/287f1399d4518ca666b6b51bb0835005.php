...
class __TwigTemplate_42139cac4ce5017e92c12f587422429f extends Template
{
    private $source;
    private $macros = [];
...
(isset($context["contact"]) || array_key_exists("contact", $context) ? $context["contact"] : (function () { throw new RuntimeError('Variable "contact" does not exist.', 9, $this->source); })()), "name", [], "any", false, false, false, 9) == null)) {
    ...
    ";
            ...
            // line 15
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["contact"]) || array_key_exists("contact", $context) ? $context["contact"] : (function () { throw new RuntimeError('Variable "contact" does not exist.', 15, $this->source); })()), "birthdate", [], "any", false, false, false, 15), "Y-m-d"), "html", null, true);
            echo "</li>
...
";
    ...
    {
        return array (  130 => 27,  123 => 22,  112 => 20,  108 => 19,  102 => 16,  98 => 15,  89 => 13,  86 => 12,  80 => 10,  78 => 9,  75 => 8,  73 => 7,  68 => 4,  58 => 3,  35 => 1,);
    }
...
{% endblock %}", "contacts/contact.html.twig", "/home/abhijeet/Escritorio/symfony/guided3/templates/contacts/contact.html.twig");
    }
}
